...
def main():
    U_L2 = np.array([0.00176676, 1.19753e-05, 1.01547e-07, 6.90609e-10])
    U_Linf = np.array([0.0120542, 6.59977e-05, 3.97381e-07, 3.56103e-09])

    V_L2 = np.array([0.00317457, 2.20655e-05, 1.11008e-07, 6.28537e-10])
    V_Linf = np.array([0.0119663, 8.67333e-05, 4.24398e-07, 2.95569e-09])

    S_L2 = np.array([0.000833777, 1.07024e-05, 1.00503e-07, 6.49148e-10])
    S_Linf = np.array([0.00805548, 6.22582e-05, 4.01601e-07, 1.97838e-09])
